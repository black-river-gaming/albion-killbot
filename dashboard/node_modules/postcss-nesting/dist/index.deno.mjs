...
function s(t) {
  ...
  if ("id" === t.type) c += 1;else if ("tag" === t.type) o += 1;else if ("class" === t.type) n += 1;else if ("attribute" === t.type) n += 1;else if (function (s) {
    return parser.isPseudoElement(s);
  }(t)) o += 1;else if (parser.isPseudoClass(t)) switch (t.value) {
    case ":-moz-any":
    case ":-webkit-any":
    case ":any":
    case ":has":
    ...
    case ":nth-last-child":
      {
        n += 1;
        const s = t.nodes[0].nodes.findIndex(e => "tag" === e.type && "of" === e.value);

        if (s > -1) {
          const l = [parser.selector({
            nodes: t.nodes[0].nodes.slice(s + 1),
            value: ""
          })];
          t.nodes.length > 1 && l.push(...t.nodes.slice(1));
          const i = a(l);
          c += i.a, n += i.b, o += i.c;
        }
      }
    ...
    default:
      n += 1;
  } else parser.isContainer(t) && t.nodes.length > 0 && t.nodes.forEach(e => {
    const a = s(e);
    c += a.a, n += a.b, o += a.c;
  });
  return {
...
function a(e) {
  ...
  return e.forEach(e => {
    const t = s(e);
    t.a > a.a ? a = t : t.a < a.a || (t.b > a.b ? a = t : t.b < a.b || t.c > a.c && (a = t));
  }), a;
}
